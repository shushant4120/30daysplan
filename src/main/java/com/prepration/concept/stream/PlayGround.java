...
int n= 2;
    ...
    .sorted(Map.Entry.<Integer, Long>comparingByKey().reversed()).findFirst().ifPresentOrElse(x->System.out.println(x.getKey()+" appears "+x.getValue()+" times"), () -> System.out.println("No repeated elements"));
    }
}
